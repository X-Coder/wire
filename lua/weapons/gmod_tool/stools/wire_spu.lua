...
if CLIENT then
  language.Add("Tool_wire_spu_name", "SPU Tool (Wire)")
  language.Add("Tool_wire_spu_desc", "Spawns a sound processing unit")
  language.Add("Tool_wire_spu_0",    "Primary: create/reflash ZSPU, Secondary: open editor")
